...
//
// Related Topics 深度优先搜索 广度优先搜索 图 拓扑排序 👍 19 👎 0
...
class Za25hA {
    public static void main(String[] args) {
        Solution solution = new Za25hA().new Solution();
    }

    //leetcode submit region begin(Prohibit modification and deletion)
    class Solution {
        public int chaseGame(int[][] edges, int startA, int startB) {
            // N 个点，N条边，且所有点连通，说明有一个环
            // 连通 N 个点的需要的边至少为 N-1,
            // A 先移动，后 B 移动，问 A 能否追上 B?
            // 即，只有存在 A 与 B 相邻的情况位置，A 方能追上B
            // 在起始位置，startA, startB
            // 定义
            return 0;
        }
